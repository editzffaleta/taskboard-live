...
- Reaproveite contratos de `@<scope>/shared` sempre que houver encaixe claro.
...
- Reaproveite o namespace compartilhado exposto pelo projeto, por exemplo `@<scope>/shared`.
