...
Placeholders:
  ...
  {{fonte-dados}}        — fonte de dados/codigo (ex.: JetBrains Mono)
  {{secoes-sidebar}}     — secoes da navegacao (ex.: "Visao geral", "Conteudo", "Pessoas", "Sistema")
  {{N-telas}}            — numero de telas/mockups que sao a fonte de verdade (ex.: 58)
