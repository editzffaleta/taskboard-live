...
import { EditChecklistItem } from "../../../src/checklist-item/usecase/edit-checklist-item.usecase";
import {
  FakeCardRepository,
...
async function setup() {
  ...
  return { useCase, card, item, otherCard };
}

describe("EditChecklistItem", () => {
  it("edita o texto do item", async () => {
    ...
    expect(checklist[0].text).toBe("Novo texto");
  });
