...
import { DeleteLabel } from "../../../src/label/usecase/delete-label.usecase";
...
function setup() {
  ...
  const useCase = new DeleteLabel(labelRepository, membershipRepository);
  return { labelRepository, membershipRepository, useCase };
}

describe("DeleteLabel", () => {
  it("remove a etiqueta", async () => {
