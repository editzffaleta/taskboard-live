...
import { UnassignLabel } from "../../../src/label/usecase/unassign-label.usecase";
import {
...
describe("UnassignLabel", () => {
  it("remove a etiqueta do cartao e retorna o cartao com labels atualizado", async () => {
  ...
  it("e idempotente ao remover uma etiqueta nao atribuida", async () => {
    const { useCase, card, label } = await setup();
