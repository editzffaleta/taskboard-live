<!-- TEMPLATE — design do design system. Placeholders: TaskBoard Live, #2563EB,
#1D4ED8, Inter, JetBrains Mono, "Quadros", "Conta", 6. -->
...
6 telas do TaskBoard Live definem a identidade visual real: paleta, fontes, suporte a **tema
...
6 telas do TaskBoard Live.

## Goals / Non-Goals

**Goals:**
- Aplicar a paleta TaskBoard Live (primaria + semanticas + escala neutra) via CSS variables, em claro e escuro.
- Configurar a tipografia da marca (Inter para texto, JetBrains Mono para dados/codigo).
...
- **Tokens TaskBoard Live (das telas)**: primario `#2563EB` (hover/realce
  `#1D4ED8`); escala neutra para superficies/bordas/textos; semanticas `success`,
...
- **Fontes via `next/font`**: Inter e JetBrains Mono, carregadas localmente para evitar
